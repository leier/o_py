'''
  ...
  | Usage: python o.py past_sales_figures.csv no_boot_strapping_realization
  |
...
def main(filename='teaser1.csv',pprice=30,cprice=20,no_boot_strapping_realization=10000, verbose=False):
...
if __name__ == "__main__":
  if len(sys.argv) < 3 or len(sys.argv) > 3:
    print "type: python o.py <file.csv> <number_realizations>"
    print "e.g. python o.py teaser1.csv 5000"
    print "continue with default: teaser1.csv 5000"
    main('teaser1.csv',30,20,5000,False)
  else:
    filename=sys.argv[1]
